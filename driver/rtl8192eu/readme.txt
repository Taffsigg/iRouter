...
===============================================================================
	...
	2. document/
		...
		2.18 Quick_Start_Guide_for_Adaptivity_and_Carrier_Sensing_Test.doc
		2.19 HowTo_debug_BT_coexistence.pdf

	3. driver/
		3.1 rtl8192EU_linux_v4.3.15_14701.20150715_BTCOEX20150615-41.tar.gz
	...
	4. wpa_supplicant_hostapd/
	  ...
	  4.5 wpa_supplicant_hostapd-0.8_rtw_r7475.20130812.tar.gz
		...
		4.7 wpa_supplicant_8_kk_4.4_rtw_r12456.20141003.tar.gz
			 ...
			 could be used for pure-linux Android 4.4. Support only cfg80211/nl80211.	 
	...
	12. btcoex/
		12.1 How_to_set_bt-coex_antenna_isolation_parameters_on_combo_card.pdf
			Guide for setting bt-coex antenna isolation parameters on combo card module
		12.2 wifi_ant_isolation.txt
